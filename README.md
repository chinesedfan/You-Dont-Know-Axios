...
- If the above method is not working then you have to set the value of `access-control-expose-headers` to the header that you want to expose to the axios in Response Headers issued from the server.
